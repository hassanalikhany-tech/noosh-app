...
export const UK_DISHES: Dish[] = [
  {
    ...
    "ingredients": [
      ...
      { "item": "فیله ماهی سفید (کاد، هادوک یا تیلاپیا، بدون پوست و استخوان)", "amount": 4, "unit": "تکه" },
      { "item": "آرد سفید", "amount": 1, "unit": "پیمانه" },
      { "item": "بیکینگ پودر", "amount": 1, "unit": "قاشق چایخوری" },
      { "item": "نمک", "amount": 0.5, "unit": "قاشق چایخوری" },
      { "item": "فلفل سیاه", "amount": 0.25, "unit": "قاشق چایخوری" },
      { "item": "آبجو سرد (لاگر) یا آب گازدار سرد", "amount": 1, "unit": "پیمانه" },
      { "item": "روغن نباتی یا کانولا (برای سرخ کردن عمیق)", "amount": 1.25, "unit": "لیتر" },
      { "item": "سیب‌زمینی (متوسط تا بزرگ، مناسب سرخ کردن)", "amount": 4, "unit": "عدد" },
      { "item": "نمک (برای چیپس)", "amount": 0, "unit": "به میزان لازم" },
      { "item": "سرکه مالت (برای سرو)", "amount": 0, "unit": "به میزان لازم" },
      { "item": "لیمو ترش (برش خورده، برای سرو)", "amount": 1, "unit": "عدد" }
    ],
    "recipeSteps": [
