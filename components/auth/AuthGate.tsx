...
const AuthGate: React.FC<AuthGateProps> = ({ children }) => {
  ...
  if (!isAuthenticated) return (
    <div className="h-screen landscape:h-auto landscape:min-h-screen landscape:overflow-visible w-full flex items-center justify-center metallic-navy p-4 dir-rtl overflow-hidden">
      <div className="w-full max-w-md h-[620px] landscape:h-auto bg-white rounded-[3.5rem] shadow-2xl p-8 sm:p-10 animate-enter overflow-hidden landscape:overflow-visible transition-all duration-500 border border-white/20 flex flex-col justify-center">
