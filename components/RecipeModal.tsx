          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
              ...
              <div className="lg:col-span-7 space-y-6">
                ...
                {user && hasIngredients && (
                  <button onClick={handleAddAllToCart} className={`w-full py-5 rounded-[2rem] font-black text-lg transition-all flex items-center justify-center gap-3 shadow-xl mt-4 ${addedToCart ? 'bg-emerald-500 text-white scale-95' : 'bg-slate-900 text-white hover:bg-teal-600'}`}>
